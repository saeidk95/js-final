...
export default function welcomePage1(){
    ...
    <div class="w-[428px] h-[926px] ">
      <div class="bg-cover bg-center w-[428px] h-[602px]" style="background-image: url('./public/picture/slide1.png');">
      </div>
      <div class="flex flex-col gap-8">
        <div class="flex flex-col font-bold text-3xl mt-10 w-[380px] h-[91px] mx-auto">
          <div class="px-3 mt-2 text-center mx-auto flex justify-center"> We provide High quality products just for you
          </div>
        </div>
...
export function clickNext1(){
  document.querySelector("#btn").addEventListener("click", (e)=>{
      e.preventDefault()      
  router.navigate(routs.welcome2)        
  })
